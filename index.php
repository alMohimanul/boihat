...
<li><a href="#" style="text-decoration: none;" class="fas fa-user" data-bs-toggle="modal" data-bs-target="#exampleModalToggle"></a></li>
    ...
    <section id="hero">
        <div class="content">
            ...
            <button class="btn-1" onclick="location.href='/registration/buyer/buyer_registration.html'">Register as BUYER</button>
            <button class="btn-2" onclick="location.href='/registration/seller/seller_registration.html'">Register as SELLER</button>
